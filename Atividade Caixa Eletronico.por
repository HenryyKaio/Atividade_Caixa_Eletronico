programa
{
	...
	inteiro notas_20 = 0
	inteiro notas_50 = 0
	inteiro restoNotas_20 = 0
	inteiro restoNotas_10 = 0
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		restoNotas_20 = (valor_saque - (notas_50*50)-20)/10
		se(restoNotas_20 == 0){
			restoNotas_20++
		}
		se(restoNotas_20 < 0){
		...
		restoNotas_10 = (valor_saque - (notas_50*50) - restoNotas_20*20)/10
		se(restoNotas_10 == 2){
			restoNotas_10 = 0
		} 
	}
	...
	funcao mostra_dinheiro()
	{
		...
		se (notas_20 <= 2 ou notas_20 > 8) {
			para (inteiro n = 0; n < restoNotas_20; n++) {
				Graficos.desenhar_imagem(n * 10 + 200, 440 +130 + n * 10, vinte_reais)
			}
		}

		se (notas_10 < 2 ou notas_10 > 17) {
			para (inteiro n = 0; n < restoNotas_10; n++) {
